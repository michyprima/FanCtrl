...
### Algorithm
At idle the fans will run at 50% and rump up to 100% when the temperature gets over 65 °C with a cooldown of 5 seconds. You can customize this in `FanCtrl.cs`.
